  ...
  return (
    <aside className="w-full lg:w-64 bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-800 flex-col hidden lg:flex h-screen sticky top-0">
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        <a
          href="#"
          className="flex items-center gap-3 px-4 py-3 text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/50 rounded-xl font-medium transition-colors"
        >
      ...
      <div className="p-4 border-t border-gray-100 dark:border-slate-800">
        <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-800 cursor-pointer transition-colors">
          <img
          ...
          <LuChevronRight className="w-4 h-4 text-gray-400 dark:text-slate-500" />
        </div>
      </div>
    </aside>
  );
